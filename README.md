This is the project of NBE-E4225 Mapping, Decoding and Modeling the human brain at Aalto University (2025 Spring)      
Replicating the data analysis pipeline of the paper:       
